...
- `apps/backend/interfaces/api/routers/upscale.py` — image upscale plus dedicated SeedVR2 video-upscale endpoint.
...
- `apps/backend/interfaces/api/tasks/video_upscale_tasks.py` — dedicated SeedVR2 video-upscale task lifecycle worker.
