...
- Own the bootstrap/tokenizer/text-feature gate while Lens remains parked and non-runnable.
...
## Notes
- This folder is bootstrap-only in the current tranche. It must not import upstream `lens`, construct Diffusers pipelines, load tensor payloads, or claim generation support.
