...
- `SeedVR2UpscaleOptions` (dataclass): Required SeedVR2 model selection plus curated runtime and execution-policy controls for the dedicated video-upscale task.
"""
