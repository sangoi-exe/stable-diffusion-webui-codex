...
## Key Files
- `seedvr2.py` — SeedVR2 child runner (exact upstream geometry/padding, phase-specific host/CUDA/MPS live-set admission, MPS unified-memory admission, source video -> upstream CLI -> numerically validated PNG output paths).
