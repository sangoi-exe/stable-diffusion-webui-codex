...
## Key Files
- `seedvr2.py` — SeedVR2 child runner (exact upstream geometry/padding, phase-specific host/CUDA/MPS live-set admission including method-specific MPS Phase 4 color-correction workspace, MPS unified-memory admission, source video -> upstream CLI -> numerically validated PNG output paths).
