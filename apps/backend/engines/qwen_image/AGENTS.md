...
## Key Files
- `apps/backend/engines/qwen_image/qwen_image.py` — engine registration target; validates the exact core-only transformer/TEnc/VAE bundle and owns patcher-backed native runtime assembly.
