...
## Key Files
- `apps/backend/engines/qwen_image/qwen_image.py` — engine registration target; validates the exact core-only transformer/TEnc/VAE bundle, owns patcher-backed native runtime assembly, and exposes the loaded family runtime to the canonical img2img use-case.
